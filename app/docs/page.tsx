...
const requirements: Record<string, string> = {
  ...
  bags: "Server API key and wallet approvals for fee-share config + launch",
...
export default function Docs() {
  return <><Header/><main className="docs">
    ...
    <section><h2>Provider behavior</h2><div className="unsupported">
      ...
      <article><strong>Bags</strong><p>Uses the complete Bags v2 flow: token metadata, an automatic 100% creator fee-share configuration, then the launch transaction. The developer key stays on Railway.</p></article>
