...
export function Header() {
  ...
  return <header className="site-header">
    <Link href="/" className="brand" aria-label="Anything Solana home"><img src="https://www.anything.family/anything-logo.webp" alt=""/><span>anything<span>.solana</span></span></Link>
