...
export function Header() {
  ...
  return <header className="site-header">
    <Link href="/" className="brand" aria-label="Anything Solana home"><Image src="/anything-logo.png" alt="" width={46} height={46} priority/><span>anything<span>.solana</span></span></Link>
