...
export function Header() {
  ...
  return <header className="site-header">
    <Link href="/" className="brand" aria-label="Anything Solana home"><Image src="/anything-logo.png" alt="" width={62} height={62} sizes="62px" priority/><span>anything<span>.solana</span></span></Link>
